      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: "easeOut" }}>
            ...
            <h2 className="text-5xl font-bold text-gray-900 mb-8 tracking-tight leading-tight">Driven by Purpose,<br />United by Impact.</h2>
            <p className="text-xl text-gray-600 leading-relaxed mb-8 font-light">Founded with a vision to create equitable opportunities for all, SEBaid Foundation operates on the belief that sustainable development starts at the community level.</p>
            <p className="text-lg text-gray-500 leading-relaxed mb-12">We focus on health equity, skill acquisition, and social support systems designed to uplift the most vulnerable. Our team is driven by compassion, integrity, and a relentless pursuit of impact.</p>
            <div className="grid grid-cols-2 gap-x-12 gap-y-16 pt-12">
              <div>
                <h3 className="text-5xl md:text-6xl font-semibold text-gray-900 mb-2 tracking-tighter">120+</h3>
                <p className="text-gray-500 font-medium tracking-wide text-sm uppercase">Lives Impacted</p>
              </div>
              <div>
                <h3 className="text-5xl md:text-6xl font-semibold text-gray-900 mb-2 tracking-tighter"><Counter from={0} to={12} />+</h3>
                <p className="text-gray-500 font-medium tracking-wide text-sm uppercase">Communities Served</p>
              </div>
              <div>
                <h3 className="text-5xl md:text-6xl font-semibold text-gray-900 mb-2 tracking-tighter">15+</h3>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative">
            ...
            <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="absolute -bottom-12 -left-12 bg-white/90 backdrop-blur-xl p-10 rounded-[2rem] shadow-xl max-w-sm hidden md:block border border-white/20">
              ...
              <p className="text-gray-600 text-base leading-relaxed">To empower underserved individuals and communities impacted by natural disasters, systemic poverty, and abuse through equitable access to education, skills development, and holistic health resources.</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
